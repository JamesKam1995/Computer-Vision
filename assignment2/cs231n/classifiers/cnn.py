...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        out, cache1 = conv_bn_relu_forward(X, W1, b1, conv_param, pool_param)
        ...
        dout, grads['W2'], grads['b2'], _, _ = affine_relu_backward(dout, cache2)
        dout, grads['W1'], grads['b1'], _, _ = conv_relu_pool_backward(dout, cache1)
