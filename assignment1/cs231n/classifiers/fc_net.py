...
class TwoLayerNet(object):
    ...
    def __init__(
        ...
        self.params = {
        "W1" : np.random.randn(input_dim, hidden_dim) * weight_scale, #gaussian distribution
        "b1" : np.zeros(hidden_dim),
        "W2" : np.random.randn(hidden_dim, num_classes) * weight_scale, #gaussian distribution
